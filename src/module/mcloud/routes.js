...
import IOT from './views/components/plat/IOT';
...
import MFR from './views/components/Intelligence/MFR';
import MIR from './views/components/Intelligence/MIR';
import OCR from './views/components/Intelligence/OCR';
import AIP from './views/components/Intelligence/AIP';
import MRS from './views/components/Intelligence/MRS';
    ...
    children:[
      ...
      },
      {
            ...
            children:[
                  ...
                  {
                    path:'/mcloud/productdetail/Intelligence/MRS',
                    name:'智能推荐系统（MRS）',
                    component: MRS
                  }
            ]
